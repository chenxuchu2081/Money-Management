...
class PieChart{
    ...
    static func setupPieChart(pieView: PieChartView, NameSet: [ExpendLimited]) {
        ...
        for item in NameSet{
            entries.append(PieChartDataEntry(value: item.price, label: item.typeName))
        }
...
//        dataSet.colors = [c1, c2, c3, c4, c5]
     ...
     static func setupPieChart(pieView: PieChartView, NameSet: [IncomeLimited]) {
